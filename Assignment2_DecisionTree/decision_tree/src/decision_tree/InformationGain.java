...
public class InformationGain {
	...
	public static double getInformationGain(ArrayList<Record> dataTable, int featureIndx, double median){
	...
	private static double getEntropy(ArrayList<Record> dataTable, int givenIndx, double givenMedian, int compare){
		double entropy;
	...
	private static double getConditionalEntropy(ArrayList<Record> dataTable, int featureIndx, double featureMedian){
