...
public class FileReader {
	...
	public static ArrayList<Record> buildRecord(String path){
		...
		try{
			...
			while ((row = reader.readLine()) != null){
				...
				if(error){
					int errLine = recordTable.size()+numDeletedRows;
					numDeletedRows += 1;
		...
		System.out.println("Done building "+recordTable.size()+" records!");
		return recordTable;
	}
